    ...
    <div class="row">
      ...
      <table class="table table-striped table-bordered">
        ...
        <tbody>
          ...
          // var_dump($item); // ligne par ligne je récupère un tableau associatif avec 5 clés(index) et valeurs en affichant 1 par 1 les entré de la table items grâce a fetch comparé a fetchAll ou il récupère toutes les lignes et les affiches tous
