...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1909819518ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.3" media="print" id="printcss">
    <title>localhost:8080 / localhost:3307 | phpMyAdmin 5.1.3</title>
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=burger_code&table=categories">`burger_code`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=burger_code&table=items">`burger_code`.`items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=burguer_code&table=category">`burguer_code`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=burguer_code&table=item">`burguer_code`.`item`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=burguer_code&table=categories">`burguer_code`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bitnami_wordpress&table=wp_posts">`bitnami_wordpress`.`wp_posts`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6c616a685a7d5e39764d6b7c6165725e">
...
<nav id="server-breadcrumb" aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="localhost:3307">
